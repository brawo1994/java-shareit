...
public class ItemController {
    ...
    public List<ItemDto> getItemsByUserId(@RequestHeader(SHARER_USER_ID_HEADER) long userId,
        ...
        return itemService.getItemsByUserId(userId, new Pagination(from, size, Sort.by(Sort.Direction.ASC, "id")));
    }
    ...
    public List<ItemDto> searchItems(@RequestParam String text,
        ...
        return itemService.searchItemsByText(text, new Pagination(from, size, Sort.by(Sort.Direction.ASC, "id")));
    }
